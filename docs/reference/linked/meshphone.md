...
Questions about the MeshPhone Network can be directed to Mark, preferably via [email](mailto:n2mh@n2mh.net) or N2MH on Discord. On the mesh, he can be reached at `n2mh@n2mh-mailhub.local.mesh`. His MeshPhone number is 973-2111.

For more information about AREDN Mesh, go to [arednmesh.org](https://www.arednmesh.org)
...
Don't know the number of the person you are trying to call on the MeshPhone Network? Look them up in the [MeshPhone White Pages](http://ntwomh.ddns.net:5894/MeshPhone/whitepages.php).
