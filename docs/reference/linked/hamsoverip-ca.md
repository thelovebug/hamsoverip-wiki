# Hams Over IP Canada VOIP Network
...
Questions about the Hams Over IP Canada Network can be directed to Jesse, preferably via [email](mailto:wh6av@hamsoverip.com) or WH6AV on Discord. His MeshPhone number is 808-3027.
...
* Try it: dial `450714263` (VA2DG). You should reach VA2DG Extension.  Leave a voicemail if you'd like to.
...
Don't know the number of the person you are trying to call on the Hams Over IP Canada Network? Look them up in the [Hams Over IP Canada Phonebook](https://hamsoverip.ca/phonebook/).
